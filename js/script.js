...
//Arrays to store each ToDo and Completed items 
const todos = (localStorage.getItem('todos') ? JSON.parse(localStorage.getItem('todos')) : []);	
const completed = (localStorage.getItem('completed') ? JSON.parse(localStorage.getItem('completed')) : []);

loadItens();

//Loads todos and completed Arrays items into addItemToDOM function
function loadItens() {
 ...
 * upon clicking on the "+" button or by pressing the "enter" key. It doesn't accept blank items (no text on the field) and cleans the text 
...
/*
 * This function receives a text from the input field and adds it as inner Text of a new li element
 ...
 * It also uploads the local Storage.
 */
function removeItem() {
 ...
 * and removes it. It also uploads the local Storage.
 */
...
//Uploading localStorage based on changes of todos and completed lists;
